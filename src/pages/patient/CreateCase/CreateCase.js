...
import {Button, Chip, Grid, Snackbar} from 'material-ui';
...
class CreateCase extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            medicine: [
                {id: 0, label: '1.Medicine'},
                {id: 1, label: '2.Medicine'},
                {id: 2, label: '3.Medicine'},
                {id: 3, label: '4.Medicine'},
                {id: 4, label: '5.Medicine'},],
        };
                ...
                <div style={{width: '100%', position: 'relative', overflow: 'hidden'}}>
                    <Grid container>
                        ...
                        <Grid item xs={12} style={{
                            height: '88vh', backgroundColor: 'white', justify: 'center',
                            display: '-webkit-box',
                            display: '-webkit-flex',
                            display: '-ms-flexbox',
                            display: 'flex',
...
// Zehra bir an önce iyileşşe de gezsek
// Çok seviyorum be abiiiiii
